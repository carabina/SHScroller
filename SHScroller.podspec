...
Pod::Spec.new do |s|
  s.name             = 'SHScroller'
  s.version          = '0.1.0'
  s.summary          = 'A short description of SHScroller.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/SHScroller'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Sho Miyamoto' => 'laveritefigaro+cocoa@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/SHScroller.git', :tag => s.version.to_s }
